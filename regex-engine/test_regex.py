from regex-engine import is_match
import pytest


@pytest.mark.parametrize(
    "regex, string, expected, _",
    [
        # stage 1
        ...
        (
            ...
            "a",
            "True",
            "Don't forget that '.' is a wild-card that matches any single character.",
        ),
        ...
        (
            ...
            "",
            "False",
            "A non-empty regex and an empty input string always returns False!",
        ),
        # stage 2
        (
            "apple",
            "apple",
            "True",
            "Two identical equal-length patterns should return True!",
        ),
        (
            ".pple",
            "apple",
            "True",
            "The wild-card '.' should match any single character in a string.",
        ),
        (
            "appl.",
            "apple",
        ...
        (
            ...
            "apple",
            "True",
            "If the input string contains the regex, it should return True!",
        ),
        (
            "app",
            "apple",
        ...
        (
            ...
            "apple",
            "True",
            "Even a single wild-card character '.' can produce a match!",
        ),
...
def test_cases(regex, string, expected, _):
    values = {"True": True, "False": False}
    assert is_match(regex, string) is values[expected]
